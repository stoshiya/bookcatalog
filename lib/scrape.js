...
exports.oreilly = function(callback) {
  get('http://www.oreilly.co.jp/catalog/soon.xml', oreilly, function(array) {
    callback(array);
  });
}

exports.computerbookjp = function(callback) {
  get('http://www.computerbook.jp/rss/books/index.xml', computerbookjp, function(array) {
    callback(array);
  });
}
...
function get(uri, func, callback) {
  ...
  request.get(option, function(err, response, body) {
    ...
    callback(func(cheerio.load(body)));
  });
}

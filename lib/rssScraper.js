...
exports.oreilly = function(callback) {
  request('http://www.oreilly.co.jp/catalog/soon.xml', oreilly, false, callback);
};

exports.computerbookjp = function(callback) {
  request('http://www.computerbook.jp/rss/books/index.xml', computerbookjp, false, callback);
};
...
function computerbookjp($) {
  return $('item').map(function() {
    ...
    Array.prototype.forEach.call($(this).children('description').text().replace(/\r/g, '').split('\n'), function(element) {
